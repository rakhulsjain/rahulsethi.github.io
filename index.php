...
<body>
	<div class="container">
		...
		1. <a href="state.php">Search By State and city</a><br>
					...
					<div class="col-md-6">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="pincode" placeholder="6 Digit Pincode"  name="pincode" maxlength="6">
							</div>
						</div>
	...
	$(document).ready(function () {
		...
		$(document).on( 'click', '.fetch', function () {
			...
			$.ajax({
				url: "ajax.php",
				type:"POST",
				data:{date:date, pincode:pincode, age:age,  pin:pin},
